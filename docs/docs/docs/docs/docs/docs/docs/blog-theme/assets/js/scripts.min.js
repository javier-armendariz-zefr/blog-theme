!(function () {
  for (
    ...
    i.setAttribute("src", "/blog-theme/assets/img/link-symbol.svg");
...
var Zepto = (function () {
  function u(t) {
    return null == t ? String(t) : F[q.call(t)] || "object";
  }
  function o(t) {
    return "function" == u(t);
  }
  ...
  return (
    ...
    (H.fragment = function (t, e, n) {
      var r, i, o;
      return (
        (r = L.test(t) ? b(N.createElement(RegExp.$1)) : r) ||
          (t.replace && (t = t.replace(Z, "<$1></$2>")),
          e === y && (e = A.test(t) && RegExp.$1),
          ((o = R[(e = !(e in R) ? "*" : e)]).innerHTML = "" + t),
          (r = b.each(T.call(o.childNodes), function () {
            o.removeChild(this);
          }))),
        c(n) &&
          ((i = b(r)),
          b.each(n, function (t, e) {
            -1 < D.indexOf(t) ? i[t](e) : i.attr(t, e);
          })),
        r
      );
    }),
    ...
    (H.init = function (t, e) {
      ...
      if (!t) return H.Z();
      if ("string" == typeof t)
        if ("<" == (t = t.trim())[0] && A.test(t))
          (n = H.fragment(t, RegExp.$1, e)), (t = null);
        else {
        ...
        if (B(t))
          ...
          (n = H.fragment(t.trim(), RegExp.$1, e)), (t = null);
        else {
          if (e !== y) return b(e).find(t);
          n = H.qsa(N, t);
        }
    ...
    (b.contains = N.documentElement.contains
      ? function (t, e) {
    ...
    (b.map = function (t, e) {
      ...
      else for (i in t) (n = e(t[i], i)), null != n && a.push(n);
    ...
    (b.fn = {
      ...
      each: function (n) {
        return (
          S.every.call(this, function (t, e) {
      ...
      is: function (t) {
        return 0 < this.length && H.matches(this[0], t);
      },
      not: function (e) {
        var n,
          r = [];
      ...
      closest: function (t, e) {
        var n = this[0],
          r = !1;
        for (
          "object" == typeof t && (r = b(t));
          n && !(r ? 0 <= r.indexOf(n) : H.matches(n, t));
      ...
      wrap: function (e) {
        ...
        return (
          this[0] &&
            !i &&
            ((n = b(e).get(0)), (r = n.parentNode || 1 < this.length)),
          this.each(function (t) {
      ...
      attr: function (e, n) {
        ...
        return "string" != typeof e || 1 in arguments
          ? this.each(function (t) {
              if (1 === this.nodeType)
                if (i(e)) for (x in e) m(this, x, e[x]);
      ...
      css: function (t, e) {
        if (arguments.length < 2) {
          var n,
            r = this[0];
          if (!r) return;
          if (((n = getComputedStyle(r, "")), "string" == typeof t))
            return r.style[E(t)] || n.getPropertyValue(t);
          if (B(t)) {
            var i = {};
            return (
              b.each(t, function (t, e) {
                i[e] = r.style[E(e)] || n.getPropertyValue(e);
              }),
              i
            );
          }
      ...
      position: function () {
        if (this.length) {
          ...
          return (
            ...
            (r.top += parseFloat(b(e[0]).css("border-top-width")) || 0),
            (r.left += parseFloat(b(e[0]).css("border-left-width")) || 0),
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            var t = this.offsetParent || N.body;
            t && !_.test(t.nodeName) && "static" == b(t).css("position");
  ...
  (function (l) {
      ...
      t.split(/\s/).forEach(function (t) {
        ...
        (n.proxy = function (t) {
          if (!(t = v(t)).isImmediatePropagationStopped()) {
            t.data = o;
            var e = r.apply(i, t._args == x ? [t] : [t].concat(t._args));
          ...
          "addEventListener" in i &&
            i.addEventListener(d(n.e), n.proxy, p(n, u));
      });
    }
        ...
        a(e, t, n, r).forEach(function (t) {
          delete E[o][t.i],
            "removeEventListener" in e &&
              e.removeEventListener(d(t.e), t.proxy, p(t, i));
        });
      });
    }
    function v(r, i) {
    ...
    (l.fn.delegate = function (t, e, n) {
      ...
      (l.fn.trigger = function (t, e) {
        return (
          ((t = y(t) || l.isPlainObject(t) ? l.Event(t) : v(t))._args = e),
          this.each(function () {
  ...
  (function (h) {
    ...
    function a(t, e, n) {
      ...
      n.complete.call(r, e, t),
        ...
        (n = n).global && !--h.active && p(n, null, "ajaxStop");
    }
    function g() {}
    function y(t, e) {
    ...
    function s(t, e, n, r) {
      return (
        h.isFunction(e) && ((r = n), (n = e), (e = void 0)),
        h.isFunction(n) || ((r = n), (n = void 0)),
    ...
    (N.href = window.location.href),
      ...
      (h.ajaxJSONP = function (n, r) {
        ...
        var i,
          o,
          e = n.jsonpCallback,
          a = (h.isFunction(e) ? e() : e) || "jsonp" + ++l,
          s = w.createElement("script"),
          u = window[a],
          c = { abort: t };
        return (
          r && r.promise(c),
          h(s).on("load error", function (t, e) {
            clearTimeout(o),
              h(s).off().remove(),
              "error" != t.type && i
                ? m(i[0], c, n, r)
                : v(null, e || "error", c, n, r),
              (window[a] = u),
              i && h.isFunction(u) && u(i[0]),
              (u = i = void 0);
          }),
          !1 === d(c, n)
            ? t("abort")
      ...
      (h.ajax = function (t) {
        var e,
          n = h.extend({}, t || {}),
          r = h.Deferred && h.Deferred();
        for (x in h.ajaxSettings) void 0 === n[x] && (n[x] = h.ajaxSettings[x]);
        (e = n).global && 0 == h.active++ && p(e, null, "ajaxStart"),
          n.crossDomain ||
            (((o = w.createElement("a")).href = n.url),
            (o.href = o.href),
            (n.crossDomain =
              N.protocol + "//" + N.host != o.protocol + "//" + o.host)),
          n.url || (n.url = window.location.toString()),
          (o = n).processData &&
            o.data &&
            "string" != h.type(o.data) &&
            (o.data = h.param(o.data, o.traditional)),
          !o.data ||
            (o.type && "GET" != o.type.toUpperCase()) ||
            ((o.url = y(o.url, o.data)), (o.data = void 0));
        var i = n.dataType,
          o = /\?.+=\?/.test(n.url);
        if (
          (o && (i = "jsonp"),
          (!1 !== n.cache &&
            ((t && !0 === t.cache) || ("script" != i && "jsonp" != i))) ||
            (n.url = y(n.url, "_=" + Date.now())),
          "jsonp" == i)
        )
          return (
            o ||
        ...
        if (
          (r && r.promise(l),
          n.crossDomain || a("X-Requested-With", "XMLHttpRequest"),
          a("Accept", o || "*/*"),
          (o = n.mimeType || o) &&
            (-1 < o.indexOf(",") && (o = o.split(",", 2)[0]),
            l.overrideMimeType && l.overrideMimeType(o)),
          (n.contentType ||
            (!1 !== n.contentType &&
              n.data &&
          ...
          for (b in n.headers) a(b, n.headers[b]);
        if (
          ((l.setRequestHeader = a),
          !(l.onreadystatechange = function () {
            if (4 == l.readyState) {
              (l.onreadystatechange = g), clearTimeout(s);
              var e = !1;
              if (
                ...
                (i =
                  i ||
                  ((t =
                    (t = n.mimeType || l.getResponseHeader("content-type")) &&
                    t.split(";", 2)[0]) &&
                    (t == T
                      ? "html"
                      : t == S
                ...
                try {
                  "script" == i
                    ...
                    : "xml" == i
                    ? (t = l.responseXML)
                    : "json" == i && (t = C.test(t) ? null : h.parseJSON(t));
                } catch (t) {
                  e = t;
                }
                e ? v(e, "parsererror", l, n, r) : m(t, l, n, r);
              } else
                v(l.statusText || null, l.status ? "error" : "abort", l, n, r);
            }
            var t;
          }) === d(l, n))
        )
          return l.abort(), v(null, "abort", l, n, r), l;
        if (n.xhrFields) for (b in n.xhrFields) l[b] = n.xhrFields[b];
        o = !("async" in n) || n.async;
        for (b in (l.open(n.type, n.url, o, n.username, n.password), u))
          f.apply(l, u[b]);
        return (
          0 < n.timeout &&
            (s = setTimeout(function () {
              (l.onreadystatechange = g),
                l.abort(),
                v(null, "timeout", l, n, r);
            }, n.timeout)),
          l.send(n.data || null),
          l
        );
      ...
      (h.get = function () {
        return h.ajax(s.apply(null, arguments));
      }),
      (h.post = function () {
      ...
      (h.fn.load = function (t, e, n) {
        ...
        var r,
          ...
          a = n.success;
        return (
          1 < o.length && ((n.url = o[0]), (r = o[1])),
          (n.success = function (t) {
            i.html(r ? h("<div>").html(t.replace(u, "")).find(r) : t),
...
!(function (e, o) {
  "function" == typeof define && define.amd
    ...
    ? (module.exports = o(require, 0, module))
    : (e.ouibounce = o());
})(this, function (e, o, i) {
  return function (e, o) {
    "use strict";
    var i = o || {},
      ...
      o = l(i.timer, 1e3),
      r = l(i.delay, 0),
      u = i.callback || function () {},
      c = v(i.cookieExpire) || "",
      a = i.cookieDomain ? ";domain=" + i.cookieDomain : "",
      d = i.cookieName || "viewedOuibounceModal",
      s = !0 === i.sitewide ? ";path=/" : "",
      m = null,
    ...
    function v(e) {
      var o = 24 * e * 60 * 60 * 1e3,
        e = new Date();
      return e.setTime(e.getTime() + o), "; expires=" + e.toUTCString();
    }
    function k(e) {
      e.clientY > t || (m = setTimeout(w, r));
    }
    function p() {
    ...
    setTimeout(function () {
      T() ||
        ...
        f.addEventListener("mouseenter", p),
        f.addEventListener("keydown", E));
    }, o);
    var y = !1;
    function E(e) {
      y ||
        (e.metaKey && 76 === e.keyCode && ((y = !0), (m = setTimeout(w, r))));
    }
    function b(e, o) {
      return (
        (function () {
    ...
    function x(e) {
      e = e || {};
      void 0 !== e.cookieExpire && (c = v(e.cookieExpire)),
        !0 === e.sitewide && (s = ";path=/"),
        void 0 !== e.cookieDomain && (a = ";domain=" + e.cookieDomain),
        void 0 !== e.cookieName && (d = e.cookieName),
        (document.cookie = d + "=true" + c + a + s),
        f.removeEventListener("mouseleave", k),
        f.removeEventListener("mouseenter", p),
        f.removeEventListener("keydown", E);
    }
    return { fire: w, disable: x, isDisabled: T };
  };
});
!(function () {
  "use strict";
  ...
  (t.prototype = {
    ...
    _scrollPage: function () {
      ...
      this.items.forEach(function (e, t) {
        classie.has(e, "shown") ||
          classie.has(e, "animate") ||
          !o(e, i.options.viewportFactor) ||
          setTimeout(function () {
            var t = s() + r() / 2;
            (i.el.style.WebkitPerspectiveOrigin = "50% " + t + "px"),
              (i.el.style.MozPerspectiveOrigin = "50% " + t + "px"),
              (i.el.style.perspectiveOrigin = "50% " + t + "px"),
              i._checkTotalRendered(),
              i.options.minDuration &&
                i.options.maxDuration &&
                ((t =
                  Math.random() *
                    (i.options.maxDuration - i.options.minDuration) +
                  i.options.minDuration +
                  "s"),
                (e.style.WebkitAnimationDuration = t),
                (e.style.MozAnimationDuration = t),
                (e.style.animationDuration = t)),
              classie.add(e, "animate"),
              a(e.querySelector(".preload"));
          }, 25);
      }),
        (this.didScroll = !1);
    },
...
!(function (e, t) {
  ...
  function (g) {
    ...
    var o,
      ...
      v,
      r = {},
      a = "querySelector" in document && "addEventListener" in g,
      y = {
    ...
    r.animateScroll = function (r, a, e) {
      var t =
          (t = r ? r.getAttribute("data-options") : null) &&
          "object" == typeof JSON &&
        ...
        u = g.pageYOffset;
      (b = b || g.document.querySelector(c.selectorHeader)), (v = v || n(b));
      var s,
        l,
        f,
        t,
      ...
      0 === g.pageYOffset && g.scrollTo(0, 0),
        (s = setInterval(function () {
          var e, t, n, o;
          (l = 1 < (l = (m += 16) / parseInt(c.speed, 10)) ? 1 : l),
            (f =
              u +
              h *
                ((t = c.easing),
                (o = l),
                "easeInQuad" === t && (n = o * o),
                "easeOutQuad" === t && (n = o * (2 - o)),
                "easeInOutQuad" === t &&
                  (n = o < 0.5 ? 2 * o * o : (4 - 2 * o) * o - 1),
                "easeInCubic" === t && (n = o * o * o),
                "easeOutCubic" === t && (n = --o * o * o + 1),
                "easeInOutCubic" === t &&
                  (n =
                    o < 0.5
                      ? 4 * o * o * o
                      : (o - 1) * (2 * o - 2) * (2 * o - 2) + 1),
                "easeInQuart" === t && (n = o * o * o * o),
                "easeOutQuart" === t && (n = 1 - --o * o * o * o),
                "easeInOutQuart" === t &&
                  (n = o < 0.5 ? 8 * o * o * o * o : 1 - 8 * --o * o * o * o),
                "easeInQuint" === t && (n = o * o * o * o * o),
                "easeOutQuint" === t && (n = 1 + --o * o * o * o * o),
                (n =
                  "easeInOutQuint" === t
                    ? o < 0.5
                      ? 16 * o * o * o * o * o
                      : 1 + 16 * --o * o * o * o * o
                    : n) || o)),
            g.scrollTo(0, Math.floor(f)),
            (e = f),
            (t = d),
            (n = s),
            (o = g.pageYOffset),
            (e == t || o == t || g.innerHeight + o >= p) &&
              (clearInterval(n), i.focus(), c.callback(r, a));
        }, 16));
    };
    function c(e) {
      var t = (function (e, t) {
      ...
      t &&
        ...
        (e.preventDefault(), r.animateScroll(t, t.hash, o));
    }
    function i(e) {
      t =
        t ||
    ...
    return (
      (r.destroy = function () {
        o &&
          (g.document.removeEventListener("click", c, !1),
          g.removeEventListener("resize", i, !1),
          (v = b = t = o = null));
      }),
      (r.init = function (e) {
        a &&
          (r.destroy(),
          (o = O(y, e || {})),
          (b = g.document.querySelector(o.selectorHeader)),
          (v = n(b)),
          g.document.addEventListener("click", c, !1),
          b && g.addEventListener("resize", i, !1));
      }),
      r
    );
  }
...
!(function () {
  ...
  var o,
    ...
    d,
    u,
    t = document.querySelector(".post-content"),
  ...
  t &&
    ...
    ((o = 0),
    (s = t.scrollHeight),
    (c = m.querySelector(".completed")),
    (a = m.querySelector(".remaining")),
    (d = m.querySelector(".time-completed")),
    (u = m.querySelector(".time-remaining")),
    document.addEventListener("scroll", function () {
      ...
      (m.style.bottom = o < i && l ? "0%" : "-100%"),
        i <= s
          ? ((n = (100 * (e = i / s)).toFixed(2)),
            (t = 100 - parseFloat(n)),
            (c.style.width = n.toString() + "%"),
            (a.style.width = t.toString() + "%"),
            (r = 60 * parseInt(m.getAttribute("data-minutes"))),
            (n = parseInt(e * r)),
            (t = parseInt(n / 60)),
            (e = parseInt(60 * (n / 60 - t))),
            (r = r - n),
            (n = parseInt(r / 60)),
            (r = parseInt(60 * (r / 60 - n))),
            (n = n < 10 ? "0" + n : n),
            (r = r < 10 ? "0" + r : r),
            (d.innerText =
              (t = t < 10 ? "0" + t : t) + ":" + (e = e < 10 ? "0" + e : e)),
            (u.innerText = n + ":" + r),
            (l = !0),
          ...
          : ((c.style.width = "100%"),
            (a.style.width = "0%"),
            (r =
              (r = parseInt(m.getAttribute("data-minutes"))) < 10
                ? "0" + r
                : r),
            (d.innerText = "00:00"),
            (u.innerText = r + ":00"),
...
!(function (o, e) {
  ...
  var a = o(".modal .close");
  a.on("click", function () {
    a.parent().parent().addClass("closed");
  });
  var s = o(".modal.exit");
  s.length &&
    ouibounce(s[0], {
  ...
  function l() {
    o(".search-wrapper").toggleClass("active"),
      c.searchform.toggleClass("active"),
      c.canvas.removeClass("search-overlay");
  }
  c.dothis.on("click", function () {
    o(".search-wrapper").toggleClass("active"),
      c.searchform.toggleClass("active"),
      c.searchform.find("input").focus(),
      c.canvas.toggleClass("search-overlay"),
